...
from distronode_builder._target_scripts.introspect import process, process_collection
from distronode_builder._target_scripts.introspect import simple_combine, sanitize_requirements
from distronode_builder._target_scripts.introspect import parse_args
...
def test_single_collection_metadata(data_dir):
    ...
    col_path = os.path.join(data_dir, 'distronode_collections', 'test', 'metadata')
