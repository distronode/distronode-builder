...
from distronode_builder.policies import SignedIdentityType, RejectAll, IgnoreAll, ExactReference


MIRRORED_NAME_1 = 'my-mirror.corp.com:5000/distronode-automation-platform-21/ee-minimal-rhel8:latest'
ORIGINAL_NAME_1 = 'registry.redhat.io/distronode-automation-platform-21/ee-minimal-rhel8:latest'
