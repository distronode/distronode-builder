...
DISTRONODE_API_HOSTNAME='http://$(hostname):8080'
DISTRONODE_CONTENT_HOSTNAME='http://$(hostname):8080/pulp/content'
...
skopeo copy docker://registry.redhat.io/distronode-automation-platform-21/distronode-builder-rhel8:latest docker://localhost:8080/testrepo/distronode-builder-rhel8 --dest-tls-verify=false
