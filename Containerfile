...
# build this library (meaning distronode-builder)
COPY . /tmp/src
COPY ./src/distronode_builder/_target_scripts/* /output/scripts/
...
COPY ./src/distronode_builder/_target_scripts/assemble /usr/local/bin/assemble
