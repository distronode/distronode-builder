    ...
    "properties": {
        ...
        "dependencies": {
            ...
            "properties": {
                ...
                "distronode_core": {
                    "description": "Distronode package installation",
                    "type": "object",
                    "additionalProperties": False,
                    "properties": {
                        "package_pip": {
                            "description": "Distronode package to install via pip",
                            "type": "string",
                        },
                    },
                    "oneOf": [
                ...
                "distronode_runner": {
                    "description": "Distronode Runner package installation",
                    "type": "object",
                    "additionalProperties": False,
                    "properties": {
                        "package_pip": {
                            "description": "Distronode Runner package to install via pip",
                            "type": "string",
                        },
                    },
                    "oneOf": [
        ...
        "options": {
            ...
            "properties": {
                ...
                "skip_distronode_check": {
                    "description": "Disables the check for Distronode/Runner in final image",
                    "type": "boolean",
                },
                "workdir": {
...
def _handle_options_defaults(ee_def: dict):
    ...
    options.setdefault('skip_distronode_check', False)
